        ...
        <div class="container-fluid ">
            ...
            <form action="/signup" method="post">
                <table border="1">
                    ...
                    <tr ><th width="70">PW:</th> <td><input type="password" name="psw" size="13"></td></tr>
                    <tr ><th width="70">Name:</th> <td><input type="text" name="name" size="13"></td></tr>
                    <tr ><th width="70">Gender:</th> <td><input type="text" name="gender" size="13"></td></tr>
                    <tr ><th width="70">Email:</th> <td><input type="text" name="email" size="13"></td></tr>
                    <tr align="center">
                        <td colspan="2">
