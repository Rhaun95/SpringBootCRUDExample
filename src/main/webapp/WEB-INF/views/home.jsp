...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <!-- Page content-->
        <div class="container-fluid">
            <h2 class="mt-4"> <strong>Mini Practice with Spring Boot, JSP, Mybatis, MySQL, and Bootstrap</strong> </h2>

            <p>This webpage includes functions for CRUD(insert, update, remove, and search) by board content and user.</p>
        </div>
    </div>
</div>
<!-- Bootstrap core JS-->
